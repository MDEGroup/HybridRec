...
public class TopicSimilarityCalculator {
	...
	final static Logger logger = Logger.getLogger(TopicSimilarityCalculator.class);
	...
	public TopicSimilarityCalculator(String sourceDir, String subFolder, int trStartPos1, int trEndPos1,
			int trStartPos2, int trEndPos2, int teStartPos, int teEndPos, boolean bayesian) {
